...
class mod_pulse_qfsk_bpsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, device_0="232057", device_1="8243c3", device_2="90a7c7", device_3="4a0a4f", device_4="24644f", device_5="6f2e4f", device_6="53454f"):
        gr.top_block.__init__(self, "mod_pulse_qfsk_bpsk", catch_exceptions=True)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, "D:/GNUradio/data/20230801/{}_qfsk_bpsk".format(device), False)
    ...
    def set_device(self, device):
        self.device = device
        self.blocks_file_sink_0.open("D:/GNUradio/data/20230801/{}_qfsk_bpsk".format(self.device))
