...
class mod_pulse_costas(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, device_0="232057", device_1="8243c3", device_2="90a7c7", device_3="4a0a4f", device_4="24644f", device_5="6f2e4f", device_6="53454f"):
        gr.top_block.__init__(self, "mod_pulse_costas", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("mod_pulse_costas")
        ...
        self.settings = Qt.QSettings("GNU Radio", "mod_pulse_costas")
        ...
        self.carrier_freq_2 = carrier_freq_2 = carrier_freq+step_freq*2.5
        self.carrier_freq_1 = carrier_freq_1 = carrier_freq-step_freq*2.5
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_b(np.random.permutation(np.arange(0, 5)), True, 1, [])
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, "D:/GNUradio/data/20230801/{}_costas".format(device), False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_complex_to_float_0 = blocks.complex_to_float(1)
        self.blocks_add_const_vxx_0 = blocks.add_const_ff(((carrier_freq_1)/1e6))
    ...
    def set_step_freq(self, step_freq):
        ...
        self.set_carrier_freq_1(self.carrier_freq-self.step_freq*2.5)
        self.set_carrier_freq_2(self.carrier_freq+self.step_freq*2.5)
    ...
    def set_device(self, device):
        self.device = device
        self.blocks_file_sink_0.open("D:/GNUradio/data/20230801/{}_costas".format(self.device))
    ...
    def set_carrier_freq_1(self, carrier_freq_1):
        ...
        self.blocks_add_const_vxx_0.set_k(((self.carrier_freq_1)/1e6))
...
def main(top_block_cls=mod_pulse_costas, options=None):
    if options is None:
