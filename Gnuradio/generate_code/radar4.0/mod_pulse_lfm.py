...
class mod_pulse_lfm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, device_0="232057", device_1="8243c3", device_2="90a7c7", device_3="4a0a4f", device_4="24644f", device_5="6f2e4f", device_6="53454f"):
        gr.top_block.__init__(self, "mod_pulse_lfm", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("mod_pulse_lfm")
        ...
        self.settings = Qt.QSettings("GNU Radio", "mod_pulse_lfm")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, "D:/GNUradio/data/20230801/{}_lfm".format(device), False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_complex_to_float_0 = blocks.complex_to_float(1)
        self.blocks_add_const_vxx_0 = blocks.add_const_ff(((carrier_freq-step_freq)/1e6))
        self.analog_sig_source_x_0_0_0_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, (1/pw), (step_freq/1e6), 0, 0)
        self.analog_agc_xx_0 = analog.agc_cc((1e-4), 1.0, 1.0)
        self.analog_agc_xx_0.set_max_gain(65536)
        self._SNR_range = Range(-15, 30, 1, 15, 200)
        ...
        self.connect((self.analog_sig_source_x_0_0_0_0, 0), (self.blocks_add_const_vxx_0, 0))
    ...
    def set_pw(self, pw):
        self.pw = pw
        self.set_RRC_0(firdes.root_raised_cosine(1.0, 1/self.pw, 1/self.pw/2, 0.35, (11*self.sps)))
        self.analog_sig_source_x_0_0_0_0.set_frequency((1/self.pw))
    ...
    def set_step_freq(self, step_freq):
        ...
        self.analog_sig_source_x_0_0_0_0.set_amplitude((self.step_freq/1e6))
    ...
    def set_device(self, device):
        self.device = device
        self.blocks_file_sink_0.open("D:/GNUradio/data/20230801/{}_lfm".format(self.device))
...
def main(top_block_cls=mod_pulse_lfm, options=None):
    if options is None:
