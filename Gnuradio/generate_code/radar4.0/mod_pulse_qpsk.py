...
class mod_pulse_qpsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, device_0="232057", device_1="8243c3", device_2="90a7c7", device_3="4a0a4f", device_4="24644f", device_5="6f2e4f", device_6="53454f"):
        gr.top_block.__init__(self, "mod_pulse_qpsk", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("mod_pulse_qpsk")
        ...
        self.settings = Qt.QSettings("GNU Radio", "mod_pulse_qpsk")
        ...
        self.phase_symbol_width = phase_symbol_width = 1e-6
        ...
        self.RRC = RRC = firdes.root_raised_cosine(1.0, samp_rate,samp_rate/sps, 0.35, (11*sps))
        ...
        self.fir_filter_xxx_0 = filter.fir_filter_ccc(1, RRC)
        ...
        self.blocks_repeat_0_1 = blocks.repeat(gr.sizeof_char*1, (int(samp_rate*phase_symbol_width)))
        self.blocks_repeat_0_0_0 = blocks.repeat(gr.sizeof_char*1, (int(samp_rate*phase_symbol_width)))
        self.blocks_repeat_0_0 = blocks.repeat(gr.sizeof_char*1, (int(samp_rate*phase_symbol_width)))
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_char*1, (int(samp_rate*phase_symbol_width)))
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, "D:/GNUradio/data/20230801/{}_16qam".format(device), False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_complex_to_float_0 = blocks.complex_to_float(1)
        self.blocks_char_to_float_0_0_1 = blocks.char_to_float(1, np.sqrt(2))
        self.blocks_char_to_float_0_0_0_0 = blocks.char_to_float(1, np.sqrt(2))
        self.blocks_char_to_float_0_0_0 = blocks.char_to_float(1, (np.sqrt(2)/2))
        self.blocks_char_to_float_0_0 = blocks.char_to_float(1, (np.sqrt(2)/2))
        self.blocks_add_xx_0 = blocks.add_vcc(1)
        self.blocks_add_const_vxx_0_0_0 = blocks.add_const_cc(-np.sqrt(2)/4+np.sqrt(2)/4j)
        self.blocks_add_const_vxx_0_0 = blocks.add_const_cc(-np.sqrt(2)/2+np.sqrt(2)/2j)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 1000e3, 1, 0, 0)
        self.analog_random_uniform_source_x_0_0_0_0 = analog.random_uniform_source_b(0, 2, 3)
        self.analog_random_uniform_source_x_0_0_0 = analog.random_uniform_source_b(0, 2, 2)
        self.analog_random_uniform_source_x_0_0 = analog.random_uniform_source_b(0, 2, 1)
        ...
        self.connect((self.analog_random_uniform_source_x_0_0, 0), (self.blocks_repeat_0, 0))
        self.connect((self.analog_random_uniform_source_x_0_0_0, 0), (self.blocks_repeat_0_0_0, 0))
        self.connect((self.analog_random_uniform_source_x_0_0_0_0, 0), (self.blocks_repeat_0_1, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_multiply_xx_0, 1))
        self.connect((self.blocks_add_const_vxx_0_0, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.blocks_add_const_vxx_0_0_0, 0), (self.blocks_add_xx_0, 1))
        ...
        self.connect((self.blocks_char_to_float_0_0_0, 0), (self.blocks_float_to_complex_0_0, 1))
        self.connect((self.blocks_char_to_float_0_0_0_0, 0), (self.blocks_float_to_complex_0_0_0, 1))
        self.connect((self.blocks_char_to_float_0_0_1, 0), (self.blocks_float_to_complex_0_0_0, 0))
        ...
        self.connect((self.blocks_float_to_complex_0_0_0, 0), (self.blocks_add_const_vxx_0_0_0, 0))
        ...
        self.connect((self.blocks_repeat_0_0_0, 0), (self.blocks_char_to_float_0_0_1, 0))
        self.connect((self.blocks_repeat_0_1, 0), (self.blocks_char_to_float_0_0_0_0, 0))
        ...
        self.connect((self.fir_filter_xxx_0, 0), (self.blocks_multiply_xx_0, 0))
        ...
        self.connect((self.fir_filter_xxx_0_0, 0), (self.blocks_multiply_xx_1, 1))
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.set_RRC(firdes.root_raised_cosine(1.0, self.samp_rate, self.samp_rate/self.sps, 0.35, (11*self.sps)))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_repeat_0.set_interpolation((int(self.samp_rate*self.phase_symbol_width)))
        self.blocks_repeat_0_0.set_interpolation((int(self.samp_rate*self.phase_symbol_width)))
        self.blocks_repeat_0_0_0.set_interpolation((int(self.samp_rate*self.phase_symbol_width)))
        self.blocks_repeat_0_1.set_interpolation((int(self.samp_rate*self.phase_symbol_width)))
    ...
    def get_phase_symbol_width(self):
        return self.phase_symbol_width

    def set_phase_symbol_width(self, phase_symbol_width):
        self.phase_symbol_width = phase_symbol_width
        self.blocks_repeat_0.set_interpolation((int(self.samp_rate*self.phase_symbol_width)))
        self.blocks_repeat_0_0.set_interpolation((int(self.samp_rate*self.phase_symbol_width)))
        self.blocks_repeat_0_0_0.set_interpolation((int(self.samp_rate*self.phase_symbol_width)))
        self.blocks_repeat_0_1.set_interpolation((int(self.samp_rate*self.phase_symbol_width)))
    ...
    def set_device(self, device):
        self.device = device
        self.blocks_file_sink_0.open("D:/GNUradio/data/20230801/{}_16qam".format(self.device))
    ...
    def set_RRC(self, RRC):
        self.RRC = RRC
        self.fir_filter_xxx_0.set_taps(self.RRC)
...
def main(top_block_cls=mod_pulse_qpsk, options=None):
    if options is None:
