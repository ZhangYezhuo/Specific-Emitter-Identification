...
class mod_pulse_qpsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, device_0="232057", device_1="8243c3", device_2="90a7c7", device_3="4a0a4f", device_4="24644f", device_5="6f2e4f", device_6="53454f"):
        gr.top_block.__init__(self, "mod_pulse_qpsk")
        ...
        self.pw = pw = 100e-6
        self.pri = pri = 200e-6
        self.phase_symbol_width = phase_symbol_width = 8e-6
        ...
        self.channels_channel_model_0 = channels.channel_model(
            ...
            noise_seed=0,
            block_tags=False)
        self.blocks_unpack_k_bits_bb_0 = blocks.unpack_k_bits_bb(int(phase_symbol_width*1e6))
