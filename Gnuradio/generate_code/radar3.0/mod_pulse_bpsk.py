...
class mod_pulse_bpsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, device_0="232057", device_1="8243c3", device_2="90a7c7", device_3="4a0a4f", device_4="24644f", device_5="6f2e4f", device_6="53454f"):
        gr.top_block.__init__(self, "mod_pulse_bpsk")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("mod_pulse_bpsk")
        ...
        self.settings = Qt.QSettings("GNU Radio", "mod_pulse_bpsk")
...
def main(top_block_cls=mod_pulse_bpsk, options=None):
    if options is None:
