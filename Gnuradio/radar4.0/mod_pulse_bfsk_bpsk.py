...
class mod_pulse_bfsk_bpsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, device_0="232057", device_1="8243c3", device_2="90a7c7", device_3="4a0a4f", device_4="24644f", device_5="6f2e4f", device_6="53454f"):
        gr.top_block.__init__(self, "mod_pulse_bfsk_bpsk", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("mod_pulse_bfsk_bpsk")
        ...
        self.settings = Qt.QSettings("GNU Radio", "mod_pulse_bfsk_bpsk")
        ...
        self.carrier_freq_1 = carrier_freq_1 = carrier_freq-step_freq/2
        ...
        self.blocks_repeat_0_0 = blocks.repeat(gr.sizeof_char*1, (int(samp_rate*symbol_width)))
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, "D:/GNUradio/data/20230801/{}_bfsk_bpsk".format(device), False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_complex_to_float_0 = blocks.complex_to_float(1)
        self.blocks_char_to_float_0_0 = blocks.char_to_float(1, 0.5)
        self.blocks_add_const_vxx_0_0 = blocks.add_const_cc(-1)
        ...
        self.analog_random_source_x_0_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(1, 3, 1000))), True)
        ...
        self.connect((self.analog_random_source_x_0_1, 0), (self.blocks_repeat_0_0, 0))
        self.connect((self.blocks_add_const_vxx_0, 0), (self.blocks_vco_c_0, 0))
        self.connect((self.blocks_add_const_vxx_0_0, 0), (self.fir_filter_xxx_0, 0))
    ...
    def set_step_freq(self, step_freq):
        ...
        self.set_carrier_freq_1(self.carrier_freq-self.step_freq/2)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_repeat_0_0.set_interpolation((int(self.samp_rate*self.symbol_width)))
    ...
    def set_device(self, device):
        self.device = device
        self.blocks_file_sink_0.open("D:/GNUradio/data/20230801/{}_bfsk_bpsk".format(self.device))
...
def main(top_block_cls=mod_pulse_bfsk_bpsk, options=None):
    if options is None:
