...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._output_index_range = Range(0, 1, 1, 0, 200)
        self._output_index_win = RangeWidget(self._output_index_range, self.set_output_index, "'output_index'", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_grid_layout.addWidget(self._output_index_win, 4, 0, 1, 2)
        for r in range(4, 5):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._input_index_range = Range(0, 2, 1, 0, 200)
        self._input_index_win = RangeWidget(self._input_index_range, self.set_input_index, "'input_index'", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_grid_layout.addWidget(self._input_index_win, 3, 0, 1, 2)
        for r in range(3, 4):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._freq_range = Range(0, samp_rate/4, 1, 200, 200)
        self._freq_win = RangeWidget(self._freq_range, self.set_freq, "'freq'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_grid_layout.addWidget(self._freq_win, 2, 0, 1, 2)
        for r in range(2, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.analog_sig_source_x_2 = analog.sig_source_c(samp_rate, analog.GR_SAW_WAVE, freq, 1, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_c(samp_rate, analog.GR_TRI_WAVE, freq, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_2, 0), (self.blocks_selector_0, 2))
        self.connect((self.blocks_selector_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.blocks_selector_0, 1), (self.qtgui_time_sink_x_1, 0))
