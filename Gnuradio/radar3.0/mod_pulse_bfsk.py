...
class mod_pulse_bfsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, device_0="232057", device_1="8243c3", device_2="90a7c7", device_3="4a0a4f", device_4="24644f", device_5="6f2e4f", device_6="53454f"):
        gr.top_block.__init__(self, "mod_pulse_bfsk")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("mod_pulse_bfsk")
        ...
        self.settings = Qt.QSettings("GNU Radio", "mod_pulse_bfsk")
        ...
        self.gain_range = gain_range = 0.2
        ...
        # Blocks
        ##################################################
        self._gain_range_range = Range(0, 1, 0.1, 0.2, 200)
        ...
        self.uhd_usrp_source_0.set_normalized_gain(gain_range, 0)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, "/home/zhouzinan/Documents/IndividualRadar/dataset_grc/all_mod_3.0/BFSK/{}".format(device), False)
        ...
        self.analog_random_source_x_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(1, 3, 1000))), True)
        ...
        self.connect((self.analog_sig_source_x_1, 0), (self.blocks_multiply_xx_0_0_0_0, 1))
        ...
        self.connect((self.blocks_complex_to_float_0, 1), (self.blocks_multiply_xx_0_0_0_0, 0))
        ...
        self.connect((self.blocks_multiply_xx_0_0_0_0, 0), (self.blocks_float_to_complex_1, 1))
    ...
    def set_gain_range(self, gain_range):
        ...
        self.uhd_usrp_source_0.set_normalized_gain(self.gain_range, 0)
    ...
    def set_device(self, device):
        self.device = device
        self.blocks_file_sink_0.open("/home/zhouzinan/Documents/IndividualRadar/dataset_grc/all_mod_3.0/BFSK/{}".format(self.device))
...
def main(top_block_cls=mod_pulse_bfsk, options=None):
    if options is None:
